...
const BorrowRecordSchema = new mongoose.Schema({
  user_id: { type: mongoose.Schema.Types.ObjectId, required: true },           // Foreign key to Users table
  book_id: { type: mongoose.Schema.Types.ObjectId, required: true },           // Foreign key to Books table
